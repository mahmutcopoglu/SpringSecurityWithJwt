 ...
 * @Configuration
 * 
 * @EnableKafka public class ConsumerConfiguration {
 * 
 * @Bean public ConsumerFactory<String, String> consumerFactory() { Map<String,
 * Object> props = new HashMap<>(); props.put(
 * ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9092"); props.put(
 * ConsumerConfig.GROUP_ID_CONFIG, "consumer_group_one"); props.put(
