 ...
 * 
 * @Configuration public class ProducerConfiguration {
 * 
 * @Bean public ProducerFactory<String, String> producerFactory() { Map<String,
 * Object> configProps = new HashMap<>(); configProps.put(
 * ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9092"); configProps.put(
